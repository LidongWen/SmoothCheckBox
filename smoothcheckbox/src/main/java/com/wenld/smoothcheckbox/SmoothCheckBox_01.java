...
/**
 * <p/>
 * Author: 温利东 on 2017/2/23 15:00.
 * blog: http://blog.csdn.net/sinat_15877283
 * github: https://github.com/LidongWen
 */

public class SmoothCheckBox_01 extends CustomView implements Checkable {
    ...
    private int tickColor,mCheckedColor, mUnCheckedColor, mFloorColor, mFloorUnCheckedColor;

    private boolean mChecked;
    private boolean mTickDrawing;
    private OnCheckedChangeListener mListener;

    public SmoothCheckBox_01(Context context) {
        super(context);
    }

    public SmoothCheckBox_01(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void initValue() {
        setDefaultWidth(DensityUtils.dip2px(getContext(), DEF_DRAW_SIZE));
    ...
    public void setChecked(boolean checked) {
        ...
        invalidate();
        if (mListener != null) {
            mListener.onCheckedChanged(SmoothCheckBox_01.this, mChecked);
        }
    }
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(SmoothCheckBox_01 checkBox, boolean isChecked);
    }
}
